...
//--------------------------------------------------------------------------------------------------------------------//
            ...
            switch (swValue) {
                ...
                case 24:
                    ...
                    String regionPop = null;
                    ArrayList<Population> regionPopulation1 = Population.getRegionPopulation(regionPop, con.con);
                    // Print table of Regions and their populations
                ...
                case 27: {
                    ...
                    // Get Continent
                    System.out.println("please select the the continent to view the population:");
                    String continentPop = scanner.nextLine();

                    System.out.println("Report Additional Info 2 Selected, Displaying.....");
                    System.out.println("<|************************************************************************************|>");
                    // Getting Continent population
                    ArrayList<Population> population = Population.getContinentPopulation(continentPop, con.con);
                    // Display world population
                ...
                case 28: {
                    ...
                    // Get Region
                    System.out.println("please select the the continent to view the population:");
                    regionPop = scanner.nextLine();

                    System.out.println("Report Additional Info 3 Selected, Displaying.....");
                    System.out.println("<|************************************************************************************|>");
                    // Getting Region population
                    ArrayList<Population> population = Population.getRegionPopulation(regionPop, con.con);
                ...
                case 29: {
                    System.out.println("Report Additional Info 4 Selected, Displaying Population of selected Country...");
                    // Get Country
                    System.out.println("please select the the country to select from:");
                    String countryPop = scanner.nextLine();

                    System.out.println("Report Additional Info 4 Selected, Displaying...");
                    System.out.println("<|************************************************************************************|>");
                    // Getting country population by Country
                    ArrayList<Population> population = Population.getCountryPopulations(countryPop, con.con);
                ...
                case 30: {
                    System.out.println("Report Additional Info 5 Selected, Displaying Population of selected district...");
                    // Get District
                    System.out.println("please select the the district to select from:");
                    String districtPop = scanner.nextLine();

                    System.out.println("Report Additional Info 5 Selected, Displaying...");
                    System.out.println("<|************************************************************************************|>");
                    // Getting district population
                    ArrayList<Population> population = Population.getDistrictPopulation(districtPop, con.con);
                ...
                case 31: {
                    System.out.println("Report Additional Info 6 Selected, Displaying Population of selected City...");
                    // Get City
                    System.out.println("please select the the district to select from:");
                    String cityPop = scanner.nextLine();

                    System.out.println("Report Additional Info 6 Selected, Displaying...");
                    System.out.println("<|************************************************************************************|>");
                    // Getting city population
                    ArrayList<Population> population = Population.getcityPopulation(cityPop, con.con);
                    // Display city population
                    Population.displayCityPopulations(population);
                    System.out.println("<|************************************************************************************|>");
                    System.out.println("Report Additional Info 6 Finished, Returning to Main Menu...");
                    break;
                }
                case 32:
