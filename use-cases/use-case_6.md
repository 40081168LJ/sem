# Use Case 6 - Produce a report of the top (N) populated capital cities in an area - (N) provided by user

## Goal in Context
I want to produce a report of the top (N) populated capital cities in an area - (N) provided by user.
...
We know the number of capital cities required for the report. <br>
...
1. Organisation requests a report of the top (N) capital cities in an area. <br>
2. Employee captures the number of capital cities required for the report.
...
## Extensions
2. Number of capital cities not provided.
    * Employee informs organisation that they need to provide the number of capital cities they would like the
      report to provide information on.
3. Area provided not appropriate for a capital city report.<br>
